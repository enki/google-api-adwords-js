...
goog.provide('google.ads.adwords.examples.v201008.PerformBulkMutateJob');
...
goog.require('google.ads.adwords.v201008.BulkMutateRequest');
goog.require('google.ads.adwords.v201008.EntityId');
goog.require('google.ads.adwords.v201008.EntityIdType');
...
goog.require('google.ads.adwords.v201008.OperationStream');
...
google.ads.adwords.examples.v201008.PerformBulkMutateJob =
    function() {
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201008.PerformBulkMutateJob.prototype.
  ...
  var adGroupAdOperation = new google.ads.adwords.v201008.AdGroupAdOperation();
  adGroupAdOperation.operator = google.ads.adwords.v201008.Operator.ADD;
  ...
  var adOpStream = new google.ads.adwords.v201008.OperationStream();

  adOpStream.scopingEntityId = new google.ads.adwords.v201008.EntityId();
  adOpStream.scopingEntityId.type =
      google.ads.adwords.v201008.EntityIdType.CAMPAIGN_ID;
  ...
  for (var i = 0; i < 100; i++) {
    ...
    var criterion = new google.ads.adwords.v201008.BiddableAdGroupCriterion();
    ...
    adGroupCriterionOperation.operator =
        google.ads.adwords.v201008.Operator.ADD;
  ...
  var keywordOpStream = new google.ads.adwords.v201008.OperationStream();

  keywordOpStream.scopingEntityId = new google.ads.adwords.v201008.EntityId();
  ...
  var bulkJobId = 0;
  var bulkJob = new google.ads.adwords.v201008.BulkMutateJob();
  bulkJob.numRequestParts = 2;

  // b. Create a part of the job.
  var bulkRequest1 = new google.ads.adwords.v201008.BulkMutateRequest();
  bulkRequest1.partIndex = 0;
  bulkRequest1.operationStreams = [adOpStream];
  bulkJob.request = bulkRequest1;

  // c. Create job operation.
  var jobOperation1 = new google.ads.adwords.v201008.JobOperation();
  jobOperation1.operator = google.ads.adwords.v201008.Operator.ADD;
  ...
  try {
    bulkMutateJobService.mutate(jobOperation1,
      goog.bind(function(bulkJob) {
        ...
        bulkJob = new google.ads.adwords.v201008.BulkMutateJob();
        bulkJob.id = bulkJobId;

        var bulkRequest2 = new google.ads.adwords.v201008.BulkMutateRequest();
        bulkRequest2.partIndex = 1;
        bulkRequest2.operationStreams = [keywordOpStream];
        bulkJob.request = bulkRequest2;

        var jobOperation2 = new google.ads.adwords.v201008.JobOperation();
        jobOperation2.operator = google.ads.adwords.v201008.Operator.SET;
        ...
        bulkMutateJobService.mutate(jobOperation2,
          goog.bind(function(bulkJob) {
            ...
            var callbackFunction = goog.bind(function() {
              var selector =
                  new google.ads.adwords.v201008.BulkMutateJobSelector();
              ...
              bulkMutateJobService.get(selector,
                goog.bind(function(allJobs) {
                  if (allJobs && allJobs.length > 0) {
                    if (allJobs[0].status ==
                        google.ads.adwords.v201008.BasicJobStatus.COMPLETED ||
                        allJobs[0].status ==
                        google.ads.adwords.v201008.BasicJobStatus.FAILED) {
                      bulkJob = allJobs[0];
                      completed = true;
                    } else {
                  ...
                  if (completed) {
                    if (bulkJob.status ==
                      ...
                      for (var i = 0; i < bulkJob.numRequestParts; i++) {
                        var selector = new google.ads.adwords.v201008.
