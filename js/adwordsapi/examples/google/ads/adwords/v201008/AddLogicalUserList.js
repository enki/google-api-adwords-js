...
goog.require('google.ads.adwords.v201008.LogicalUserList');
goog.require('google.ads.adwords.v201008.LogicalUserListOperand');
goog.require('google.ads.adwords.v201008.Operator');
goog.require('google.ads.adwords.v201008.SizeRange');
goog.require('google.ads.adwords.v201008.UserInterest');
goog.require('google.ads.adwords.v201008.UserListConversionType');
goog.require('google.ads.adwords.v201008.UserListLogicalRule');
goog.require('google.ads.adwords.v201008.UserListLogicalRuleOperator');
...
goog.inherits(google.ads.adwords.examples.v201008.AddLogicalUserList,
...
google.ads.adwords.examples.v201008.AddLogicalUserList.prototype.run =
  ...
  var userList = new google.ads.adwords.v201008.LogicalUserList();
  ...
  var interest = new google.ads.adwords.v201008.UserInterest();
  interest.name = 'Mars cruise interest group';
  interest.id = 206;

  var userListOperand = new google.ads.adwords.v201008.LogicalUserListOperand();
  userListOperand.item = interest;

  var rule = new google.ads.adwords.v201008.UserListLogicalRule();
  rule.operator = google.ads.adwords.v201008.UserListLogicalRuleOperator.NONE;
  rule.ruleOperands = [userListOperand];
  userList.rules = [rule];

  operation = new google.ads.adwords.v201008.UserListOperation();
