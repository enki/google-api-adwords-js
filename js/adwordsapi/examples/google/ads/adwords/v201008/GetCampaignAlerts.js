...
goog.require('google.ads.adwords.v201008.AlertQuery');
goog.require('google.ads.adwords.v201008.AlertSelector');
goog.require('google.ads.adwords.v201008.AlertService');
goog.require('google.ads.adwords.v201008.AlertSeverity');
goog.require('google.ads.adwords.v201008.AlertType');
goog.require('google.ads.adwords.v201008.ClientSpec');
goog.require('google.ads.adwords.v201008.FilterSpec');
goog.require('google.ads.adwords.v201008.Paging');
goog.require('google.ads.adwords.v201008.TriggerTimeSpec');
...
goog.inherits(google.ads.adwords.examples.v201008.GetCampaignAlerts,
...
google.ads.adwords.examples.v201008.GetCampaignAlerts.prototype.run =
  ...
  var alertService = user.getService(
      google.ads.adwords.AdWordsService.v201008.AlertService);

  // Create the alert query.
  var query = new google.ads.adwords.v201008.AlertQuery();
  query.filterSpec = google.ads.adwords.v201008.FilterSpec.ALL;
  query.clientSpec = google.ads.adwords.v201008.ClientSpec.ALL;
  query.triggerTimeSpec = google.ads.adwords.v201008.TriggerTimeSpec.ALL_TIME;
  query.severities = [
    google.ads.adwords.v201008.AlertSeverity.GREEN,
    google.ads.adwords.v201008.AlertSeverity.YELLOW,
    google.ads.adwords.v201008.AlertSeverity.RED
  ];
  query.types = [
    google.ads.adwords.v201008.AlertType.CAMPAIGN_ENDING,
    google.ads.adwords.v201008.AlertType.CAMPAIGN_ENDED
  ];

  // Create the selector.
  var selector = new google.ads.adwords.v201008.AlertSelector();
