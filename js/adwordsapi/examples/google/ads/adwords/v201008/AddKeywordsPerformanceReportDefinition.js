...
goog.require('google.ads.adwords.v201008.DownloadFormat');
goog.require('google.ads.adwords.v201008.Operator');
goog.require('google.ads.adwords.v201008.Predicate');
goog.require('google.ads.adwords.v201008.PredicateOperator');
goog.require('google.ads.adwords.v201008.ReportDefinition');
goog.require('google.ads.adwords.v201008.ReportDefinitionDateRangeType');
goog.require('google.ads.adwords.v201008.ReportDefinitionOperation');
goog.require('google.ads.adwords.v201008.ReportDefinitionReportType');
goog.require('google.ads.adwords.v201008.ReportDefinitionService');
goog.require('google.ads.adwords.v201008.Selector');
...
google.ads.adwords.examples.v201008.AddKeywordsPerformanceReportDefinition.
  ...
  var adGroupPredicate = new google.ads.adwords.v201008.Predicate();
  adGroupPredicate.field = 'AdGroupId';
  adGroupPredicate.operator =
      google.ads.adwords.v201008.PredicateOperator.EQUALS;
  adGroupPredicate.values = [adGroupId];

  // Create selector.
  var selector = new google.ads.adwords.v201008.Selector();
  ...
  var reportDefinition = new google.ads.adwords.v201008.ReportDefinition();
  reportDefinition.reportName = 'Keywords performance report #' +
      this.getTimeStamp();
  reportDefinition.dateRangeType =
      google.ads.adwords.v201008.ReportDefinitionDateRangeType.CUSTOM_DATE;
  reportDefinition.reportType = google.ads.adwords.v201008.
      ReportDefinitionReportType.KEYWORDS_PERFORMANCE_REPORT;
  reportDefinition.downloadFormat =
      google.ads.adwords.v201008.DownloadFormat.XML;
  reportDefinition.selector = selector;

  // Create operations.
  var operation = new google.ads.adwords.v201008.ReportDefinitionOperation();
