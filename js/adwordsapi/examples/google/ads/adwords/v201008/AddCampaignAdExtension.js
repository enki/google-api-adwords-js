...
goog.require('google.ads.adwords.v201008.CampaignAdExtensionStatus');
goog.require('google.ads.adwords.v201008.GeoLocationSelector');
...
goog.inherits(google.ads.adwords.examples.v201008.AddCampaignAdExtension,
...
google.ads.adwords.examples.v201008.AddCampaignAdExtension.prototype.run =
  ...
  var address1 = new google.ads.adwords.v201008.Address();
      ...
      goog.bind(function(retval) {
        ...
        for (var i = 0, len = retval.value.length; i < len; i++) {
          ...
          var locationExtension =
              new google.ads.adwords.v201008.LocationExtension();
          ...
          locationExtension.source = google.ads.adwords.v201008.
              LocationExtensionSource.ADWORDS_FRONTEND;

          var extension = new google.ads.adwords.v201008.CampaignAdExtension();
          extension.campaignId = campaignId;
          extension.status = google.ads.adwords.v201008.
              CampaignAdExtensionStatus.ACTIVE;
          extension.adExtension = locationExtension;

          var operation =
              new google.ads.adwords.v201008.CampaignAdExtensionOperation();
