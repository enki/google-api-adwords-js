...
goog.require('google.ads.adwords.v201008.InvalidGeoLocation');
...
goog.inherits(google.ads.adwords.examples.v201008.GetGeoLocationInfo,
...
google.ads.adwords.examples.v201008.GetGeoLocationInfo.prototype.run =
  ...
  // with BOM.
  var address3 = new google.ads.adwords.v201008.Address();
      ...
      goog.bind(function(geoLocations) {
        ...
        if (geoLocations) {
          ...
          for (var i = 0, len = geoLocations.length; i < len; i++) {
            ...
            if (!(geoLocation instanceof google.ads.adwords.v201008.
                InvalidGeoLocation)) {
