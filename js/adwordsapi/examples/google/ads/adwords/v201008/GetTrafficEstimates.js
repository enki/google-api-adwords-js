...
goog.require('google.ads.adwords.v201008.AdGroupEstimateRequest');
goog.require('google.ads.adwords.v201008.CampaignEstimateRequest');
goog.require('google.ads.adwords.v201008.CountryTarget');
goog.require('google.ads.adwords.v201008.Keyword');
goog.require('google.ads.adwords.v201008.KeywordEstimateRequest');
...
goog.require('google.ads.adwords.v201008.TrafficEstimatorSelector');
goog.require('google.ads.adwords.v201008.TrafficEstimatorService');
...
google.ads.adwords.examples.v201008.GetTrafficEstimates.prototype.run =
  ...
  var trafficEstimatorService = user.getService(
      google.ads.adwords.AdWordsService.v201008.TrafficEstimatorService);

  // Create keywords. Up to 2000 keywords can be passed in a single request.
  var keyword1 = new google.ads.adwords.v201008.Keyword();
  keyword1.text = 'mars cruise';
  keyword1.matchType = google.ads.adwords.v201008.KeywordMatchType.BROAD;

  var keyword2 = new google.ads.adwords.v201008.Keyword();
  keyword2.text = 'cheap cruise';
  keyword2.matchType = google.ads.adwords.v201008.KeywordMatchType.PHRASE;

  var keyword3 = new google.ads.adwords.v201008.Keyword();
  keyword3.text = 'cruise';
  keyword3.matchType = google.ads.adwords.v201008.KeywordMatchType.EXACT;
  ...
  for (var i = 0, len = keywords.length; i < len; i++) {
    var keywordEstimateRequest =
        new google.ads.adwords.v201008.KeywordEstimateRequest();
  ...
  var adGroupEstimateRequest =
      new google.ads.adwords.v201008.AdGroupEstimateRequest();
  adGroupEstimateRequest.keywordEstimateRequests = keywordEstimateRequests;
  adGroupEstimateRequest.maxCpc = new google.ads.adwords.v201008.Money();
  adGroupEstimateRequest.maxCpc.microAmount = 1000000;

  // Create campaign estimate requests.
  var campaignEstimateRequest =
      new google.ads.adwords.v201008.CampaignEstimateRequest();
  campaignEstimateRequest.adGroupEstimateRequests = [adGroupEstimateRequest];

  var countryTarget = new google.ads.adwords.v201008.CountryTarget();
  countryTarget.countryCode = 'US';

  var languageTarget = new google.ads.adwords.v201008.LanguageTarget();
  languageTarget.languageCode = 'en';

  campaignEstimateRequest.targets = [countryTarget, languageTarget];

  // Create selector.
  var selector = new google.ads.adwords.v201008.TrafficEstimatorSelector();
          ...
          if (campaignEstimate.adGroupEstimates &&
            ...
            if (adGroupEstimate.keywordEstimates) {
              for (var i = 0, len = adGroupEstimate.keywordEstimates.length;
                ...
                var meanClicks = (keywordEstimate.min.clicks +
