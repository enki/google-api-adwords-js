...
goog.provide('google.ads.adwords.examples.v201109.GetAllExperiments');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllExperiments = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.GetAllExperiments,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllExperiments.prototype.run =
        ...
        if (page && page.entries) {
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            this.writeOutput('Experiment with name = "%s", id = "%d" and ' +
                ...
                '%d criteria, and %d ads.', experiment.name, experiment.id,
                experiment.controlId, stats.adGroupsCount,
                stats.adGroupCriteriaCount, stats.adGroupAdsCount);
          }
        } else {
