...
goog.provide('google.ads.adwords.examples.v201109.DeleteSiteLinks');

goog.require('google.ads.adwords.AdWordsService.v201109');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201109.AdExtension');
...
goog.require('google.ads.adwords.v201109.Sitelink');
goog.require('google.ads.adwords.v201109.SitelinksExtension');
...
google.ads.adwords.examples.v201109.DeleteSiteLinks = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.DeleteSiteLinks,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.DeleteSiteLinks.prototype.run = function(
    user, callback) {
  ...
  var campaignPredicate = new google.ads.adwords.v201109.Predicate();
  ...
  statusPredicate.values = [
      google.ads.adwords.v201109.CampaignAdExtensionStatus.ACTIVE
  ];
    ...
    campaignAdExtensionService.get(selector,
      goog.bind(function(page) {
        if (page && page.entries) {
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            if (extension.adExtension instanceof
                google.ads.adwords.v201109.SitelinksExtension) {
        ...
        var campaignAdExtension =
            new google.ads.adwords.v201109.CampaignAdExtension();
        campaignAdExtension.campaignId = campaignId;
        campaignAdExtension.adExtension =
            new google.ads.adwords.v201109.AdExtension();
        campaignAdExtension.adExtension.id = siteLinkExtensionId;

        var operation = new google.ads.adwords.v201109.
            CampaignAdExtensionOperation();
        operation.operator = google.ads.adwords.v201109.Operator.REMOVE;
