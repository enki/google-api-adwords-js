...
goog.provide('google.ads.adwords.examples.v201109.GetAllBulkMutateJobs');
...
google.ads.adwords.examples.v201109.GetAllBulkMutateJobs =
    function() {
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllBulkMutateJobs.prototype.
      ...
      goog.bind(function(bulkMutateJobs) {
        ...
        if (bulkMutateJobs) {
          for (var i = 0, len = bulkMutateJobs.length; i < len; i++) {
            ...
            if (bulkMutateJob.status == google.ads.adwords.v201109.
            ...
            } else if (bulkMutateJob.status == google.ads.adwords.v201109.
