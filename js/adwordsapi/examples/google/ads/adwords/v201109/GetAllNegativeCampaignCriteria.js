...
goog.provide('google.ads.adwords.examples.v201109.GetAllNegativeCampaignCriteria');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllNegativeCampaignCriteria =
    function() {
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllNegativeCampaignCriteria.prototype.
          ...
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            if (criterion instanceof google.ads.adwords.v201109.Keyword) {
              this.writeOutput('Negative keyword campaign criterion with ' +
                ...
                google.ads.adwords.v201109.Placement) {
