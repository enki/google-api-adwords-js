...
goog.provide('google.ads.adwords.examples.v201109.GetAllAdGroupCriteria');
...
goog.require('google.ads.adwords.v201109.NegativeAdGroupCriterion');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllAdGroupCriteria = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.GetAllAdGroupCriteria,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllAdGroupCriteria.prototype.run =
        ...
        if (page && page.entries && page.entries.length > 0) {
          ...
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            var isNegative = (adGroupCriterion instanceof google.ads.adwords.
                v201109.NegativeAdGroupCriterion);
