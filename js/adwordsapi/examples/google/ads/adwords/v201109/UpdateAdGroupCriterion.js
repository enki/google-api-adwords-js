...
goog.provide('google.ads.adwords.examples.v201109.UpdateAdGroupCriterion');
...
goog.require('google.ads.adwords.v201109.ManualCPCAdGroupCriterionBids');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.UpdateAdGroupCriterion = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.UpdateAdGroupCriterion,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.UpdateAdGroupCriterion.prototype.run =
  ...
  // Create bids.
  var bids = new google.ads.adwords.v201109.ManualCPCAdGroupCriterionBids();
  bids.maxCpc = new google.ads.adwords.v201109.Bid();
  bids.maxCpc.amount = new google.ads.adwords.v201109.Money();
  bids.maxCpc.amount.microAmount = 10000;

  biddableAdGroupCriterion.bids = bids;

  // Create operations.
  var operation = new google.ads.adwords.v201109.AdGroupCriterionOperation();
      ...
      goog.bind(function(retval) {
        if (retval && retval.value) {
          for (var i = 0, len = retval.value.length; i < len; i++) {
            ...
            // accordingly.
            if (adGroupCriterion instanceof google.ads.adwords.v201109.
