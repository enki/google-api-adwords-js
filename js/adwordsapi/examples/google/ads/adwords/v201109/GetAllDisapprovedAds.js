...
goog.provide('google.ads.adwords.examples.v201109.GetAllDisapprovedAds');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllDisapprovedAds = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example retrieves all the disapproved ads ' +
      'in a given campaign.';
};
goog.inherits(google.ads.adwords.examples.v201109.GetAllDisapprovedAds,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllDisapprovedAds.prototype.run =
        ...
        if (page && page.entries && page.entries.length > 0) {
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            if (adGroupAdValue.ad.approvalStatus ==
                google.ads.adwords.v201109.AdApprovalStatus.DISAPPROVED) {
