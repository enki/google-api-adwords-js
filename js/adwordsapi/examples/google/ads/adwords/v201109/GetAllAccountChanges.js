...
goog.provide('google.ads.adwords.examples.v201109.GetAllAccountChanges');

goog.require('google.ads.adwords.AdWordsService.v201109');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201109.CampaignService');
goog.require('google.ads.adwords.v201109.ChangeStatus');
goog.require('google.ads.adwords.v201109.CustomerSyncSelector');
goog.require('google.ads.adwords.v201109.CustomerSyncService');
goog.require('google.ads.adwords.v201109.DateTimeRange');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllAccountChanges = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example gets all account changes between the ' +
      'two dates specified, for all campaigns.';
};
goog.inherits(google.ads.adwords.examples.v201109.GetAllAccountChanges,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllAccountChanges.prototype.run =
    function(user, callback) {
  // Get the CustomerSyncService.
  var customerSyncService = user.getService(
      google.ads.adwords.AdWordsService.v201109.CustomerSyncService);
  ...
  var dateTimeRange = new google.ads.adwords.v201109.DateTimeRange();
  dateTimeRange.min = minDateTime;
  dateTimeRange.max = maxDateTime;

  // Create selector.
  var selector = new google.ads.adwords.v201109.CustomerSyncSelector();
            ...
            if (accountChanges && accountChanges.changedCampaigns) {
              ...
              for (var i = 0, len = accountChanges.changedCampaigns.length;
                ...
                if (campaignChanges.campaignChangeStatus !=
                    google.ads.adwords.v201109.ChangeStatus.NEW) {
...
google.ads.adwords.examples.v201109.GetAllAccountChanges.prototype.
