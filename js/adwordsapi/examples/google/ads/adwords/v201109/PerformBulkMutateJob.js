...
goog.provide('google.ads.adwords.examples.v201109.PerformBulkMutateJob');
...
goog.require('google.ads.adwords.v201109.BulkMutateJob');
goog.require('google.ads.adwords.v201109.BulkMutateJobSelector');
goog.require('google.ads.adwords.v201109.BulkMutateJobService');
goog.require('google.ads.adwords.v201109.BulkMutateRequest');
goog.require('google.ads.adwords.v201109.EntityId');
goog.require('google.ads.adwords.v201109.EntityIdType');
goog.require('google.ads.adwords.v201109.JobOperation');
goog.require('google.ads.adwords.v201109.Keyword');
goog.require('google.ads.adwords.v201109.KeywordMatchType');
goog.require('google.ads.adwords.v201109.OperationStream');
...
google.ads.adwords.examples.v201109.PerformBulkMutateJob =
    function() {
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.PerformBulkMutateJob.prototype.
    run = function(user, callback) {
  // Get the BulkMutateJobService.
  var bulkMutateJobService = user.getService(
      google.ads.adwords.AdWordsService.v201109.BulkMutateJobService);
  ...
  var adGroupAdOperation = new google.ads.adwords.v201109.AdGroupAdOperation();
  adGroupAdOperation.operator = google.ads.adwords.v201109.Operator.ADD;

  var textAd = new google.ads.adwords.v201109.TextAd();
  ...
  var adGroupAd = new google.ads.adwords.v201109.AdGroupAd();
  ...
  var adOpStream = new google.ads.adwords.v201109.OperationStream();

  adOpStream.scopingEntityId = new google.ads.adwords.v201109.EntityId();
  adOpStream.scopingEntityId.type =
      google.ads.adwords.v201109.EntityIdType.CAMPAIGN_ID;
  ...
  var keywordOpStream = new google.ads.adwords.v201109.OperationStream();

  keywordOpStream.scopingEntityId = new google.ads.adwords.v201109.EntityId();
  ...
  var bulkJobId = 0;
  var bulkJob = new google.ads.adwords.v201109.BulkMutateJob();
  bulkJob.numRequestParts = 2;

  // b. Create a part of the job.
  var bulkRequest1 = new google.ads.adwords.v201109.BulkMutateRequest();
  bulkRequest1.partIndex = 0;
  bulkRequest1.operationStreams = [adOpStream];
  bulkJob.request = bulkRequest1;

  // c. Create job operation.
  var jobOperation1 = new google.ads.adwords.v201109.JobOperation();
  jobOperation1.operator = google.ads.adwords.v201109.Operator.ADD;
  ...
  try {
    bulkMutateJobService.mutate(jobOperation1,
      goog.bind(function(bulkJob) {
        ...
        bulkJob = new google.ads.adwords.v201109.BulkMutateJob();
        bulkJob.id = bulkJobId;

        var bulkRequest2 = new google.ads.adwords.v201109.BulkMutateRequest();
        bulkRequest2.partIndex = 1;
        bulkRequest2.operationStreams = [keywordOpStream];
        bulkJob.request = bulkRequest2;

        var jobOperation2 = new google.ads.adwords.v201109.JobOperation();
        jobOperation2.operator = google.ads.adwords.v201109.Operator.SET;
        ...
        bulkMutateJobService.mutate(jobOperation2,
          goog.bind(function(bulkJob) {
            ...
            var callbackFunction = goog.bind(function() {
              var selector =
                  new google.ads.adwords.v201109.BulkMutateJobSelector();
                  ...
                  if (completed) {
                    if (bulkJob.status ==
                      ...
                      for (var i = 0; i < bulkJob.numRequestParts; i++) {
                        var selector = new google.ads.adwords.v201109.
