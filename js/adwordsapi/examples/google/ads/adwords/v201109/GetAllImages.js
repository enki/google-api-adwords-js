...
goog.provide('google.ads.adwords.examples.v201109.GetAllImages');

goog.require('google.ads.adwords.AdWordsService.v201109');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201109.Image');
goog.require('google.ads.adwords.v201109.MediaMediaType');
goog.require('google.ads.adwords.v201109.MediaService');
goog.require('google.ads.adwords.v201109.MediaSize');
goog.require('google.ads.adwords.v201109.Media_Size_DimensionsMapEntry');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.GetAllImages = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example gets all images.';
};
goog.inherits(google.ads.adwords.examples.v201109.GetAllImages,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.GetAllImages.prototype.run =
    function(user, callback) {
  // Get the MediaService.
  var mediaService = user.getService(
      google.ads.adwords.AdWordsService.v201109.MediaService);
  ...
  predicate.values = [google.ads.adwords.v201109.MediaMediaType.IMAGE];
        ...
        if (page && page.entries && page.entries.length > 0) {
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            this.writeOutput('Image with id "%d", dimensions "%dx%d", and ' +
                ...
                dimensions[google.ads.adwords.v201109.MediaSize.FULL].width,
                dimensions[google.ads.adwords.v201109.MediaSize.FULL].height,
                image.mimeType);
          }
        } else {
...
google.ads.adwords.examples.v201109.GetAllImages.prototype.
