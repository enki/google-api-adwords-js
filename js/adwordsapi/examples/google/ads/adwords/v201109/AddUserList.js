...
goog.provide('google.ads.adwords.examples.v201109.AddUserList');
...
goog.require('google.ads.adwords.v201109.RemarketingUserList');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.AddUserList = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example illustrates how to create a user list.';
};
goog.inherits(google.ads.adwords.examples.v201109.AddUserList,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.AddUserList.prototype.run =
  ...
  var conversionTrackerService = user.getService(
      google.ads.adwords.AdWordsService.v201109.ConversionTrackerService);


  var userList = new google.ads.adwords.v201109.RemarketingUserList();
  ...
  var conversionType = new google.ads.adwords.v201109.UserListConversionType();
  conversionType.name = userList.name;
  userList.conversionTypes = [conversionType];

  var operation = new google.ads.adwords.v201109.UserListOperation();
        ...
        if (retval && retval.value && retval.value.length > 0) {
          ...
          if (conversionIds.length > 0) {
            ...
            var conversionTypePredicate =
                new google.ads.adwords.v201109.Predicate();
