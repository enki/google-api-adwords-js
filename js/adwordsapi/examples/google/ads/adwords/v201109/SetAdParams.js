...
goog.provide('google.ads.adwords.examples.v201109.SetAdParams');
...
goog.require('google.ads.adwords.v201109.AdParam');
goog.require('google.ads.adwords.v201109.AdParamOperation');
goog.require('google.ads.adwords.v201109.AdParamService');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.SetAdParams = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.SetAdParams,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.SetAdParams.prototype.run =
  ...
  var adParamService = user.getService(
      google.ads.adwords.AdWordsService.v201109.AdParamService);
  ...
  var adOperand = new google.ads.adwords.v201109.AdGroupAd();
  adOperand.adGroupId = adGroupId;
  adOperand.status = google.ads.adwords.v201109.AdGroupAdStatus.ENABLED;
  adOperand.ad = textAd;

  var adOperation = new google.ads.adwords.v201109.AdGroupAdOperation();
  adOperation.operand = adOperand;
  adOperation.operator = google.ads.adwords.v201109.Operator.ADD;
    ...
    adGroupAdService.mutate([adOperation],
      goog.bind(function(retval) {
        if (retval && retval.value && retval.value.length > 0) {
          ...
          var priceParam = new google.ads.adwords.v201109.AdParam();
          ...
          var priceOperation =
              new google.ads.adwords.v201109.AdParamOperation();
          priceOperation.operator = google.ads.adwords.v201109.Operator.SET;
          priceOperation.operand = priceParam;

          var seatParam = new google.ads.adwords.v201109.AdParam();
          seatParam.adGroupId = adGroupId;
          seatParam.criterionId = criterionId;
          seatParam.paramIndex = 2;
          seatParam.insertionText = '50';

          var seatOperation = new google.ads.adwords.v201109.AdParamOperation();
          seatOperation.operator = google.ads.adwords.v201109.Operator.SET;
