...
goog.provide('google.ads.adwords.examples.v201109.CheckCampaigns');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.CheckCampaigns = function() {
...
goog.inherits(google.ads.adwords.examples.v201109.CheckCampaigns,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.CheckCampaigns.prototype.run =
  ...
  var goodCampaign = new google.ads.adwords.v201109.Campaign();
  goodCampaign.name = 'Interplanetary Cruise #' + this.getTimeStamp();
  goodCampaign.status = google.ads.adwords.v201109.CampaignStatus.PAUSED;
  goodCampaign.biddingStrategy = new google.ads.adwords.v201109.ManualCPC();

  var budget = new google.ads.adwords.v201109.Budget();
  budget.period = google.ads.adwords.v201109.BudgetBudgetPeriod.DAILY;
  budget.deliveryMethod =
      google.ads.adwords.v201109.BudgetBudgetDeliveryMethod.STANDARD;
  budget.amount = new google.ads.adwords.v201109.Money();
  ...
  try {
    campaignService.mutate([operation],
      goog.bind(function(retval) {
        ...
        var badCampaign = new google.ads.adwords.v201109.Campaign();
        badCampaign.name = 'Campaign #' + this.getTimeStamp();
        badCampaign.status = google.ads.adwords.v201109.CampaignStatus.PAUSED;
        ...
        operation = new google.ads.adwords.v201109.CampaignOperation();
        operation.operator = google.ads.adwords.v201109.Operator.ADD;
