...
goog.provide('google.ads.adwords.examples.v201109.AddLogicalUserList');

goog.require('google.ads.adwords.AdWordsService.v201109');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201109.LogicalUserList');
goog.require('google.ads.adwords.v201109.LogicalUserListOperand');
goog.require('google.ads.adwords.v201109.Operator');
goog.require('google.ads.adwords.v201109.SizeRange');
goog.require('google.ads.adwords.v201109.UserInterest');
goog.require('google.ads.adwords.v201109.UserListConversionType');
goog.require('google.ads.adwords.v201109.UserListLogicalRule');
goog.require('google.ads.adwords.v201109.UserListLogicalRuleOperator');
goog.require('google.ads.adwords.v201109.UserListMembershipStatus');
goog.require('google.ads.adwords.v201109.UserListOperation');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201109.AddLogicalUserList = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example illustrates how to create a logical ' +
      'user list.';
};
goog.inherits(google.ads.adwords.examples.v201109.AddLogicalUserList,
 ...
 *     is complete.
 */
google.ads.adwords.examples.v201109.AddLogicalUserList.prototype.run =
    function(user, callback) {
  // Get the UserListService.
  var userListService = user.getService(
      google.ads.adwords.AdWordsService.v201109.UserListService);

  var userList = new google.ads.adwords.v201109.LogicalUserList();
  ...
  userList.status = google.ads.adwords.v201109.UserListMembershipStatus.OPEN;
  ...
  var interest = new google.ads.adwords.v201109.UserInterest();
  interest.name = 'Mars cruise interest group';
  interest.id = 206;

  var userListOperand = new google.ads.adwords.v201109.LogicalUserListOperand();
  userListOperand.item = interest;

  var rule = new google.ads.adwords.v201109.UserListLogicalRule();
  rule.operator = google.ads.adwords.v201109.UserListLogicalRuleOperator.NONE;
  rule.ruleOperands = [userListOperand];
  userList.rules = [rule];

  operation = new google.ads.adwords.v201109.UserListOperation();
