...
goog.require('google.ads.adwords.v201101.ChangeStatus');
goog.require('google.ads.adwords.v201101.CustomerSyncSelector');
goog.require('google.ads.adwords.v201101.CustomerSyncService');
goog.require('google.ads.adwords.v201101.DateTimeRange');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.GetAllAccountChanges = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example gets all account changes between the ' +
      'two dates specified, for all campaigns.';
};
goog.inherits(google.ads.adwords.examples.v201101.GetAllAccountChanges,
...
google.ads.adwords.examples.v201101.GetAllAccountChanges.prototype.run =
  ...
  var customerSyncService = user.getService(
      google.ads.adwords.AdWordsService.v201101.CustomerSyncService);
  ...
  var dateTimeRange = new google.ads.adwords.v201101.DateTimeRange();
  dateTimeRange.min = minDateTime;
  dateTimeRange.max = maxDateTime;

  // Create selector.
  var selector = new google.ads.adwords.v201101.CustomerSyncSelector();
            ...
            if (accountChanges && accountChanges.changedCampaigns) {
              ...
              for (var i = 0, len = accountChanges.changedCampaigns.length;
                ...
                if (campaignChanges.campaignChangeStatus !=
                    google.ads.adwords.v201101.ChangeStatus.NEW) {
...
google.ads.adwords.examples.v201101.GetAllAccountChanges.prototype.
