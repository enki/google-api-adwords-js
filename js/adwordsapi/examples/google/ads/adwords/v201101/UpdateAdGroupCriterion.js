...
goog.provide('google.ads.adwords.examples.v201101.UpdateAdGroupCriterion');
...
goog.require('google.ads.adwords.v201101.ManualCPCAdGroupCriterionBids');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.UpdateAdGroupCriterion = function() {
...
goog.inherits(google.ads.adwords.examples.v201101.UpdateAdGroupCriterion,
 ...
 * is complete.
 */
google.ads.adwords.examples.v201101.UpdateAdGroupCriterion.prototype.run =
  ...
  // Create bids.
  var bids = new google.ads.adwords.v201101.ManualCPCAdGroupCriterionBids();
  bids.maxCpc = new google.ads.adwords.v201101.Bid();
  bids.maxCpc.amount = new google.ads.adwords.v201101.Money();
      ...
      goog.bind(function(retval) {
        if (retval && retval.value) {
          for (var i = 0, len = retval.value.length; i < len; i++) {
            ...
            // accordingly.
            if (adGroupCriterion instanceof google.ads.adwords.v201101.
