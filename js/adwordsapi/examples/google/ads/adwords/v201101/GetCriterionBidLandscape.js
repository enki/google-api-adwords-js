...
goog.provide('google.ads.adwords.examples.v201101.GetCriterionBidLandscape');

goog.require('google.ads.adwords.AdWordsService.v201101');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201101.DataService');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.GetCriterionBidLandscape = function() {
...
goog.inherits(google.ads.adwords.examples.v201101.GetCriterionBidLandscape,
 ...
 * is complete.
 */
google.ads.adwords.examples.v201101.GetCriterionBidLandscape.prototype.run =
    function(user, callback) {
  // Get the BidLandscapeService.
  var dataService = user.getService(
      google.ads.adwords.AdWordsService.v201101.DataService);
  ...
  var criterionPredicate = new google.ads.adwords.v201101.Predicate();
  criterionPredicate.field = 'CriterionId';
  criterionPredicate.operator = google.ads.adwords.v201101.PredicateOperator.IN;
      ...
      goog.bind(function(bidLandscapes) {
        ...
        if (bidLandscapes && bidLandscapes.length > 0) {
          for (var i = 0, len = bidLandscapes.length; i < len; i++) {
            ...
            if (bidLandscape instanceof google.ads.adwords.v201101.
