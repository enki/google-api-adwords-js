...
goog.require('google.ads.adwords.v201101.NegativeAdGroupCriterion');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.GetAllAdGroupCriteria = function() {
...
goog.inherits(google.ads.adwords.examples.v201101.GetAllAdGroupCriteria,
        ...
        if (page && page.entries && page.entries.length > 0) {
          ...
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            var isNegative = (adGroupCriterion instanceof google.ads.adwords.
                v201101.NegativeAdGroupCriterion);
