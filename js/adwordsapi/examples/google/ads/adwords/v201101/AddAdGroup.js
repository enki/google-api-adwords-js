...
goog.require('google.ads.adwords.v201101.AdGroupStatus');
goog.require('google.ads.adwords.v201101.Bid');
goog.require('google.ads.adwords.v201101.ManualCPCAdGroupBids');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.AddAdGroup = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example shows how to create an ad group. ' +
      'To create a campaign, run AddCampaign.js.';
};
goog.inherits(google.ads.adwords.examples.v201101.AddAdGroup,
...
google.ads.adwords.examples.v201101.AddAdGroup.prototype.run =
  ...
  adGroup.status = google.ads.adwords.v201101.AdGroupStatus.ENABLED;
  adGroup.campaignId = campaignId;

  var bids = new google.ads.adwords.v201101.ManualCPCAdGroupBids();
  var keywordMaxCpc = new google.ads.adwords.v201101.Bid();
  keywordMaxCpc.amount = new google.ads.adwords.v201101.Money();
  keywordMaxCpc.amount.microAmount = 10000000;
  bids.keywordMaxCpc = keywordMaxCpc;

  adGroup.bids = bids;

  var operation = new google.ads.adwords.v201101.AdGroupOperation();
