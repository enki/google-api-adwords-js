...
goog.provide('google.ads.adwords.examples.v201101.GetRelatedKeywords');

goog.require('google.ads.adwords.AdWordsService.v201101');
goog.require('google.ads.adwords.examples.ExampleBase');
goog.require('google.ads.adwords.v201101.AttributeType');
goog.require('google.ads.adwords.v201101.IdeaType');
goog.require('google.ads.adwords.v201101.Keyword');
goog.require('google.ads.adwords.v201101.KeywordMatchType');
goog.require('google.ads.adwords.v201101.KeywordMatchTypeSearchParameter');
goog.require('google.ads.adwords.v201101.Paging');
goog.require('google.ads.adwords.v201101.RelatedToKeywordSearchParameter');
goog.require('google.ads.adwords.v201101.RequestType');
goog.require('google.ads.adwords.v201101.TargetingIdeaSelector');
goog.require('google.ads.adwords.v201101.TargetingIdeaService');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.GetRelatedKeywords = function() {
  google.ads.adwords.examples.ExampleBase.call(this);
  this.description = 'This code example retrieves keywords that are related ' +
      'to a given keyword.';
};
goog.inherits(google.ads.adwords.examples.v201101.GetRelatedKeywords,
 ...
 * is complete.
 */
google.ads.adwords.examples.v201101.GetRelatedKeywords.prototype.run =
    function(user, callback) {
  // Get the TargetingIdeaService.
  var targetingIdeaService = user.getService(
      google.ads.adwords.AdWordsService.v201101.TargetingIdeaService);
  ...
  // Create selector.
  var selector = new google.ads.adwords.v201101.TargetingIdeaSelector();
  selector.requestType = google.ads.adwords.v201101.RequestType.IDEAS;
  selector.ideaType = google.ads.adwords.v201101.IdeaType.KEYWORD;
  selector.requestedAttributeTypes = [
      google.ads.adwords.v201101.AttributeType.CRITERION,
      google.ads.adwords.v201101.AttributeType.AVERAGE_TARGETED_MONTHLY_SEARCHES
  ];

  // Set selector paging (required for targeting idea service).
  var paging = new google.ads.adwords.v201101.Paging();
  paging.startIndex = 0;
  ...
  var relatedToKeywordSearchParameter =
      new google.ads.adwords.v201101.RelatedToKeywordSearchParameter();
  ...
  var keywordMatchTypeSearchParameter =
      new google.ads.adwords.v201101.KeywordMatchTypeSearchParameter();
  keywordMatchTypeSearchParameter.keywordMatchTypes =
      [google.ads.adwords.v201101.KeywordMatchType.BROAD];
        ...
        if (retval && retval.entries) {
          ...
          for (var i = 0, len = retval.entries.length; i < len; i++) {
            ...
            for (var j = 0, len1 = idea.data.length; j < len1; j++) {
              ...
              if (entry.key == google.ads.adwords.v201101.AttributeType.
                  CRITERION) {
