...
goog.provide('google.ads.adwords.examples.v201101.GetAllNegativeCampaignCriteria');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.GetAllNegativeCampaignCriteria =
    function() {
 ...
 * is complete.
 */
google.ads.adwords.examples.v201101.GetAllNegativeCampaignCriteria.prototype.
  ...
  selector.fields = ['Id', 'CampaignId', 'KeywordText', 'PlacementUrl'];
          ...
          for (var i = 0, len = page.entries.length; i < len; i++) {
            ...
            if (criterion instanceof google.ads.adwords.v201101.Keyword) {
              this.writeOutput('Negative keyword campaign criterion with ' +
                ...
                google.ads.adwords.v201101.Placement) {
