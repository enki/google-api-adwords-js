...
goog.require('google.ads.adwords.v201101.AdParam');
goog.require('google.ads.adwords.v201101.AdParamOperation');
goog.require('google.ads.adwords.v201101.AdParamService');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.SetAdParams = function() {
...
goog.inherits(google.ads.adwords.examples.v201101.SetAdParams,
...
google.ads.adwords.examples.v201101.SetAdParams.prototype.run =
  ...
  var adParamService = user.getService(
      google.ads.adwords.AdWordsService.v201101.AdParamService);
  ...
  var adOperand = new google.ads.adwords.v201101.AdGroupAd();
  adOperand.adGroupId = adGroupId;
  adOperand.status = google.ads.adwords.v201101.AdGroupAdStatus.ENABLED;
  adOperand.ad = textAd;

  var adOperation = new google.ads.adwords.v201101.AdGroupAdOperation();
  adOperation.operand = adOperand;
  adOperation.operator = google.ads.adwords.v201101.Operator.ADD;
    ...
    adGroupAdService.mutate([adOperation],
      goog.bind(function(retval) {
        if (retval && retval.value && retval.value.length > 0) {
          ...
          var priceParam = new google.ads.adwords.v201101.AdParam();
          ...
          var priceOperation =
              new google.ads.adwords.v201101.AdParamOperation();
          priceOperation.operator = google.ads.adwords.v201101.Operator.SET;
          priceOperation.operand = priceParam;

          var seatParam = new google.ads.adwords.v201101.AdParam();
          seatParam.adGroupId = adGroupId;
          seatParam.criterionId = criterionId;
          seatParam.paramIndex = 2;
          seatParam.insertionText = '50';

          var seatOperation = new google.ads.adwords.v201101.AdParamOperation();
          seatOperation.operator = google.ads.adwords.v201101.Operator.SET;
