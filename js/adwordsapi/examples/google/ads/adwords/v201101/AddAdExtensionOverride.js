...
goog.require('google.ads.adwords.v201101.AdExtensionOverride');
goog.require('google.ads.adwords.v201101.AdExtensionOverrideOperation');
goog.require('google.ads.adwords.v201101.AdExtensionOverrideService');
 ...
 * @constructor
 */
google.ads.adwords.examples.v201101.AddAdExtensionOverride = function() {
...
goog.inherits(google.ads.adwords.examples.v201101.AddAdExtensionOverride,
...
google.ads.adwords.examples.v201101.AddAdExtensionOverride.prototype.run =
  ...
  var adExtensionOverrideService = user.getService(
      google.ads.adwords.AdWordsService.v201101.AdExtensionOverrideService);

  var adId = this._T('INSERT_AD_ID_HERE');
  var campaignAdExtensionId = this._T('INSERT_CAMPAIGN_AD_EXTENSION_ID_HERE');

  var address = new google.ads.adwords.v201101.Address();
    ...
    geoLocationService.get(selector,
      goog.bind(function(geoLocations) {
        ...
        if (geoLocations) {
          ...
          var extension = new google.ads.adwords.v201101.LocationExtension();
          ...
          extension.source =
              google.ads.adwords.v201101.LocationExtensionSource.
                  ADWORDS_FRONTEND;
          extension.phoneNumber = '1-800-555-5556';

          var adOverride = new google.ads.adwords.v201101.AdExtensionOverride();
          adOverride.adExtension = extension;
          adOverride.adId = adId;

          var operation =
              new google.ads.adwords.v201101.AdExtensionOverrideOperation();
