...
google.ads.adwords.examples.v201101.GetAllBulkMutateJobs =
    function() {
...
google.ads.adwords.examples.v201101.GetAllBulkMutateJobs.prototype.
  ...
  // Create selector.
  var selector = new google.ads.adwords.v201101.BulkMutateJobSelector();
      ...
      goog.bind(function(bulkMutateJobs) {
        ...
        if (bulkMutateJobs) {
          for (var i = 0, len = bulkMutateJobs.length; i < len; i++) {
            ...
            if (bulkMutateJob.status == google.ads.adwords.v201101.
            ...
            } else if (bulkMutateJob.status == google.ads.adwords.v201101.
